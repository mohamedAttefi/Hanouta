...
<div class="max-w-2xl mx-auto">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">
        <i class="fas fa-edit ml-3 text-yellow-600"></i>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description_ar" rows="3" 
                              class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('description_ar', $product->description_ar) }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description_en" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('description_en', $product->description_en) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <select name="category" required
                        ...
                        <option value="خضروات" {{ old('category', $product->category) == 'خضروات' ? 'selected' : '' }}>خضروات</option>
                        <option value="فواكه" {{ old('category', $product->category) == 'فواكه' ? 'selected' : '' }}>فواكه</option>
                        <option value="ألبان" {{ old('category', $product->category) == 'ألبان' ? 'selected' : '' }}>ألبان</option>
                        <option value="لحوم" {{ old('category', $product->category) == 'لحوم' ? 'selected' : '' }}>لحوم</option>
                        <option value="مخبوزات" {{ old('category', $product->category) == 'مخبوزات' ? 'selected' : '' }}>مخبوزات</option>
                        <option value="مشروبات" {{ old('category', $product->category) == 'مشروبات' ? 'selected' : '' }}>مشروبات</option>
